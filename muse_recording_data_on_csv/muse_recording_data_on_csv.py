...
def writeValue(sensor,fileCSV):
    fileCSV.writerow([str(sensor[0]),str(sensor[1]),str(sensor[2]),str(sensor[3])])
...
if __name__ == "__main__":
    ...
    with open('data.csv', mode='w') as data_file:
        ...
        fileCSV.writerow(['delta','theta','alpha','beta'])
